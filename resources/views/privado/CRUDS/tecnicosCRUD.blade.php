<div id="overlay4" {{--onclick="off()"--}}>
    <div class="fondo">
        ...
        <div class="card">
            ...
            <div class="campos">
                <form id="formTecnicos" action="" method="POST" enctype="multipart/form-data">
                    @csrf
                    <label for="foto">Foto</label><br>
                    <input class="img-file" type="file" value="" name="foto" >
                    <br><br>
                    <label for="name">Nombre</label><br>
                    <input id="name" class="todos" type="text" value="" name="name">
                    <br><br>
                    <label for="apellido">Apellido</label><br>
                    <input id="apellido" class="todos" type="text" value="" name="apellido">
                    <br><br>
                    <label for="puesto">Puesto</label><br>
                    <input id="puesto" class="todos" type="text" value="" name="puesto">
                    <br><br>
                    <label for="domicilio">Domicilio</label><br>
                    <input id="domicilio" class="todos" type="text" value="" name="domicilio">
                    <br><br>
